...
let restart = false; // Cette letiable vaut false ce qui veut dire que par défaut, nous ne reproposons par un calcul.
do {
  // Demande un choix
  do {
    let choix = Number(
  ...
  do {
    let premierNombre = Number(prompt("Entrez un premier nombre :"));
    let deuxiemeNombre = Number(prompt("Entrez un deuxième nombre : "));
